...
##Elements find 1 or more consecutive tabs and replace with a comma. 
...
##Elements find and capture the first letter of the word, the second word, and the second numeric variable (the first numeric variable is, by default, excluded). These three captures are placed in order with capture 1 and capture 2 linked by an underscore while capture 3 is separated from the rest by a comma and space. 
...
##Elements find and capture the first three letters of the word, the first three letters of the second word, and both numeric variables. These four captures are placed in order with capture 1, capture 2, capture 4, and capture 3, separated commas and spaces. 
